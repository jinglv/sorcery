...
public enum BankNameEnum {
     ...
     * </pre>
     */
    CMB("308", "招商银行", "招行", new Integer[]{518710, 439225, 439226},
            new Integer[]{545947, 521302, 439229, 552534, 622577, 622579, 439227, 479229, 356890, 356885, 545948, 545623, 552580, 552581, 552582, 552583, 552584, 552585, 552586, 552588, 552589, 645621, 545619, 356886, 622578, 622576, 622581, 439228, 628262, 628362, 628362, 628262}),
    /**
     * <pre>
     * 兴业银行
    ...
    BankNameEnum(String code, String name, String abbrName, Integer[] debitCardPrefixes, Integer[] creditCardPrefixes) {
        ...
        this.allCardPrefixes = ArrayUtil.addAll(this.creditCardPrefixes, this.debitCardPrefixes);
    }
