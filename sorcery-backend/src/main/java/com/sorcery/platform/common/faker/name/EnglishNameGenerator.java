 ...
 */
public class EnglishNameGenerator extends BaseGenericGenerator {

    private static final BaseGenericGenerator INSTANCE = new EnglishNameGenerator();
    ...
    private String genFirstName() {
        return firstNames[getRandomInstance().nextInt(firstNames.length)];
    }
}
