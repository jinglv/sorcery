...
public class ApiResponse<T> {
    ...
    public static <T> ApiResponse<T> ofFail(T data) {
        return ofErrorCode(ApiCodeEnum.FAIL, data);
    }
    ...
    public static <T> ApiResponse<T> ofFail() {
        return ofErrorCode(ApiCodeEnum.FAIL, null);
    }
    ...
    public static <E extends CustomException, T> ApiResponse<T> ofException(E e, T data) {
        return of(CharSequenceUtil.isNotBlank(e.getCode()) ? e.getCode() : ApiCodeEnum.FAIL.getCode(), e.getMessage(), data);
    }
